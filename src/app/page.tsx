...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center p-3 justify-center min-h-full bg-base-200">
      ...
      <form
        ...
        className="flex flex-col h-auto w-full md:max-w-2/3 lg:max-w-2/5 justify-center text-xs px-3 py-3 md:p-6 rounded-md bg-base-100"
      >
